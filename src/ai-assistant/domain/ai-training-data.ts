...
export interface AiTrainingData {
  ...
  /**
   * Embedding vector generated by the local transformer model.
   * Used for semantic similarity search when `AI_PROVIDER=local`.
   * `null` means the entry has not been vectorised yet.
   */
